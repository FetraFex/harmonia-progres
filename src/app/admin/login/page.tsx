        ...
        <div className="rounded-2xl glass p-8 border border-glass-border">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="email"
                  {...register("email")}
                  className="w-full rounded-xl bg-void-2/60 border border-glass-border px-4 py-3 pl-10 text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-teal focus:border-transparent transition"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-xl bg-teal px-6 py-3.5 font-['Space_Grotesk'] font-bold text-void text-sm transition hover:scale-[1.02] hover:shadow-lg hover:shadow-teal/20 active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
