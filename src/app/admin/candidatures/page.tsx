        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/candidater"
              target="_blank"
              className="rounded-xl bg-teal px-4 py-2.5 text-xs font-bold text-void transition hover:scale-[1.02] hover:shadow-lg hover:shadow-teal/20 flex items-center gap-1.5"
            >
        ...
        <div className="rounded-2xl glass p-5 space-y-4 border border-glass-border">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl bg-void-2/60 border border-glass-border pl-10 pr-4 py-3 text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-teal focus:border-transparent transition"
            />
          </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <Link
                          href={`/admin/candidatures/${app.id}`}
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-semibold glass text-text-primary hover:bg-teal hover:text-void transition"
                        >
                          <span>Examiner</span>
