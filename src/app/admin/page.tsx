        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className="rounded-xl bg-teal px-5 py-2.5 text-xs font-bold text-void transition hover:scale-[1.02] hover:shadow-lg hover:shadow-teal/20 flex items-center gap-2"
            >
                      ...
                      <tr key={app.id} className="hover:bg-glass-bg transition group">
                        ...
                        <td className="px-6 py-4 text-right">
                          <Link
                            ...
                            className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-[11px] font-semibold glass text-text-primary hover:bg-teal hover:text-void transition"
                          >
