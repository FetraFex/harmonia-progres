      ...
      <div className="max-w-6xl mx-auto px-6 py-10 md:py-14">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <Link
              href="/candidater"
              className="self-start sm:self-auto rounded-xl bg-green px-5 py-3 font-['Space_Grotesk'] font-bold text-on-void text-sm transition hover:scale-[1.02] hover:shadow-lg hover:shadow-green/20 active:scale-[0.98] flex items-center gap-2"
            >
          ...
          <div className="rounded-2xl glass p-6 md:p-8">
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-glass-border">
              ...
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-green/10 text-teal border border-teal/20">
            ...
            {loadingApps ? (
              ...
              <div className="rounded-2xl glass p-10 md:p-14 text-center space-y-4 border border-glass-border">
                ...
                <div className="pt-2">
                  <Link
                    href="/candidater"
                    className="inline-flex items-center gap-2 rounded-xl bg-green px-6 py-3 font-['Space_Grotesk'] font-bold text-on-void text-sm transition hover:scale-[1.02] hover:shadow-lg hover:shadow-green/20"
                  >
                    <Plus className="w-4 h-4" />
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3 pt-3 lg:pt-0 border-t lg:border-t-0 border-glass-border">
                          <Link
                            ...
                            className="w-full lg:w-auto rounded-xl glass px-4 py-2.5 text-xs font-semibold text-text-primary hover:bg-green hover:text-on-void transition flex items-center justify-center gap-2"
                          >
