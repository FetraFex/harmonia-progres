          ...
          >
            <div className="relative w-[200px] h-[340px] md:w-[240px] md:h-[400px]">
              ...
              >
                ...
                {/* Manakara dot */}
                <circle cx="152.5" cy="283" r="5" fill="#CEFB48" opacity="0.9" />
                <circle cx="152.5" cy="283" r="8" fill="#CEFB48" opacity="0.2" />
                <text
                  x="168"
                  y="286"
                  className="fill-teal"
                ...
                {/* Vohipeno dot */}
                <circle cx="138" cy="288" r="4" fill="#CEFB48" opacity="0.7" />
                <circle cx="138" cy="288" r="6" fill="#CEFB48" opacity="0.15" />
                <text
                  x="138"
                  y="304"
                  textAnchor="middle"
