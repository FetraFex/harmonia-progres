  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-green/15 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 max-w-2xl mx-auto space-y-6">
                ...
                return (
                  <button
                    ...
                    className={`py-3.5 px-4 rounded-2xl font-mono font-bold text-base transition-all cursor-pointer ${
                      isSelected
                        ? "bg-green text-on-void shadow-lg shadow-green/30 scale-105"
          ...
          <div className="pt-4">
            <button
              ...
              className="w-full sm:w-auto px-10 py-4 rounded-full bg-green text-on-void font-display font-bold text-base sm:text-lg hover:bg-green/90 transition-all hover:scale-105 active:scale-95 shadow-xl shadow-green/25 cursor-pointer"
            >
